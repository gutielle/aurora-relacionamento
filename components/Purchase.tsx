      ...
      <div className="container mx-auto px-4">
        <Card className="max-w-3xl mx-auto text-center overflow-hidden">
          <div className="p-8">
            ...
            <div className="my-6">
                <p className="text-slate-400 text-2xl line-through">$96.44</p>
                <p className="text-5xl font-bold text-amber-300" style={{ textShadow: '0 0 10px rgba(252, 211, 77, 0.4)' }}>$24.22</p>
